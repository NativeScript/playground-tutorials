...
Welcome to the NativeScript-Vue getting started guide. In this first lesson, you’ll learn how to use the Playground and how to get your first NativeScript-Vue app on your device.
...
Welcome to the NativeScript Playground.
...
Before we move to the actual NativeScript-Vue development, let’s see the NativeScript Playground in action.
...
The **Components** panel provides quick access to already pre-configured code for all available NativeScript UI components. The search box is a nice shortcut to get the component you want to use without scrolling through the list.
...
* **b.** Download and install the **NativeScript Playground** app on your device by searching for “NativeScript Playground” in the App Store or Google Play, or by using the links below.
...
* **c.** Download and install the **NativeScript Preview** app on your device by searching for “NativeScript Preview” in the App Store or Google Play, or by using the links below.
...
* **f.** Use your device to scan the QR code from your browser. After a few automatic switches between apps, you should see an app that looks like the screenshots below.
