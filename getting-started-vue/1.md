...
The search box is a shortcut to get the component you want to use without scrolling through the list.
...
Without these apps, you'll miss most of the fun and excitement of playing around with Vue.js and NativeScript on an actual device.
