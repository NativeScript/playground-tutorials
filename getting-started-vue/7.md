## Lesson 7. Advanced design: Styled action bar, header, input field, and button
...
Use CSS classes to style a header. You can use the `<Label>` component in the top-level `<GridLayout>` of your first tab to style a header. 
...
### Step 3. Create an "input bar" class
