...
A starting view model for this page is already in the file at `app/views/shared/view-models/grocery-list-view-model.js`, which contains code that looks a lot like what you already have in `list-page.js`:
