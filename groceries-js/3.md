...
``` JavaScript
var user = new UserViewModel({
    email: "THE_EMAIL_YOU_REGISTERED_IN_AN_EARLIER_STEP_GOES_HERE@domain.com",
    password: "password"
});
```
